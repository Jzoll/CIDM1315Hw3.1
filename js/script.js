...
//script to split a word into individual spans
function explode() {
  //allows styling to be applied to user input
  var newness = document.getElementById("userExInput").value
  document.getElementById("wordExploded").innerHTML = newness

//specifies where styling is applied and creates spans
  $("h5").blast({ delimiter: "character" });
  $("h5").hover(
    function(){
